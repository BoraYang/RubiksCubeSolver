...
def setupLowMasks(hsvImage):
	...
	w = cv2.inRange(hsvImage,(0,0,80),(255,50,255))
	b = cv2.inRange(hsvImage,(100,100,0),(140,255,255))
	g = cv2.inRange(hsvImage,(50,50,50),(85,255,255))
...
def setupTopMasks(hsvImage):
	...
	w = cv2.inRange(hsvImage,(0,0,0),(255,50,255))
...
for i in [18,21,24,25,27,28,29,30,33,41,42,43,44]:
